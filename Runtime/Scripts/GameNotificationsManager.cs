...
namespace DBD.Notification
{
    ...
    public class GameNotificationsManager : MonoBehaviour
    {
        ...
        public IEnumerator Initialize()
        {
            ...
            args.PresentationOptions = NotificationPresentation.Alert | NotificationPresentation.Badge |
        ...
        private void OnForegrounding()
        {
            ...
            if ((mode & OperatingMode.ClearOnForegrounding) == OperatingMode.ClearOnForegrounding)
            {
                ...
                foreach (var savedNotification in loaded)
                {
                    ...
                    {
                        PendingNotification pendingNotification = ScheduleNotification(savedNotification.Notification,
                            savedNotification.DeliveryTime);
