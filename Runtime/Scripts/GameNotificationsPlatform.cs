...
namespace DBD.Notification
{
    ...
    public class GameNotificationsPlatform : IDisposable
    {
        ...
        public void ScheduleNotification(GameNotification gameNotification, DateTime deliveryTime)
        {
            ...
            {
                Title = gameNotification.InternalNotification.Title,
                Text = gameNotification.InternalNotification.Text,
                FireTime = deliveryTime,
                ShouldAutoCancel = true,
                SmallIcon = "icon_small_notification"
            };
...
#else
            int notificationId = NotificationCenter.ScheduleNotification(gameNotification.InternalNotification,
                new NotificationDateTimeSchedule(deliveryTime));
            gameNotification.Id = notificationId;
#endif
        }
