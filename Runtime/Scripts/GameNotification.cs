namespace DBD.Notification
{
    ...
    {
        private Unity.Notifications.Notification internalNotification;

        /// <summary>
        /// Gets the internal notification object used by the mobile notifications system.
        /// </summary>
        public Unity.Notifications.Notification InternalNotification => internalNotification;
        ...
        public int? Id
        {
            get => internalNotification.Identifier;
            set => internalNotification.Identifier = value;
        }
